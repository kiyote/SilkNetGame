...
internal sealed class VectorTweeningEngineTests {
	...
	public void TryGetCurrentValue_LiveAndStaleHandles_ReturnsWithoutThrowing() {
		...
		TweenHandle first = engine.StartTween( 0.0f, 10.0f, TimeSpan.FromSeconds( 2.0 ), Easing.Linear );
		...
		engine.Update( 2.0f );
		TweenHandle second = engine.StartTween( 5.0f, 20.0f, TimeSpan.FromSeconds( 2.0 ), Easing.Linear );
